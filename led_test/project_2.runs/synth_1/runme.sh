...
HD_PWD='C:/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyClockTop_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyClockTop_LED.tcl
