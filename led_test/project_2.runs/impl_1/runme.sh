...
HD_PWD='C:/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MyClockTop_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MyClockTop_LED.tcl -notrace
